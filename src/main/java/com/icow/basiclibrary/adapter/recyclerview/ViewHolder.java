...
public class ViewHolder extends RecyclerView.ViewHolder {
     ...
     * @return
     */
    public ViewHolder setTextWithStrikeFlag(int viewId, String text) {
        TextView tv = getView(viewId);
        tv.setText(text);
    ...
    public ViewHolder setImageUrl(int viewId, String url, int defaultResId, boolean isRound) {
        ImageView view = getView(viewId);
    ...
    public ViewHolder setOnCheckedChangeListener(int viewId, CompoundButton.OnCheckedChangeListener
            listener) {
