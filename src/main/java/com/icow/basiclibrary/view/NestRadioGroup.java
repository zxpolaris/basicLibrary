package com.icow.basiclibrary.view;
...
//        setOrientation(HORIZONTAL);
    ...
    /**
     * <p>
     * Sets the selection to the radio button whose identifier is passed in parameter. Using -1 as the selection identifier clears the selection; such
    ...
    /**
     * <p>
     * Clears the selection. When the selection is cleared, no radio button in this group is selected and {@link #getCheckedRadioButtonId()} returns
     * null.
     * </p>
     * 
     * @see #check(int)
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        /**
         * <p>
         * Fixes the child's width to {@link ViewGroup.LayoutParams#WRAP_CONTENT} and the child's height to
         * {@link ViewGroup.LayoutParams#WRAP_CONTENT} when not specified in the XML file.
         * </p>
         * 
         * @param a
    ...
    /**
     * <p>
     * A pass-through listener acts upon the events and dispatches them to another listener. This allows the table layout to set its own internal
