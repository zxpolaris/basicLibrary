...
public class ComUtil {
    ...
    public static void callPhone(Activity activity, String phone) {
        try {
            ...
            ToastUtil.showMessage(activity, "调用系统拨号页面失败");
        }
    ...
    public static void sendMessage(Activity activity, String phone, String msg) {
        try {
            ...
            ToastUtil.showMessage(activity, "调用系统发短息页面失败");
        }
    }
     ...
     * @return
     */
    public static String hideMiddle4Numnber(String mobile) {
    ...
    public static String formatDisputeDay(long second) {
        String html = "";
        if (second > 0) {
            String format;
            Object[] array;
            Integer day = (int) (second / (60 * 60 * 24));
            Integer hours = (int) (second / (60 * 60) - (day * 24));
            Integer minutes = (int) ((second / 60) - (day * 24 * 60 ) - ( hours * 60));
            Integer seconds = (int) (second - minutes * 60 - hours * 60 * 60);
            if (day > 0) {
                format = "%1$,d天%2$,d时%3$,d分";
                array = new Object[]{day,hours, minutes};
            }else if(hours > 0){
                format = "%1$,d时%2$,d分";
                array = new Object[]{hours, minutes};
            }else if (minutes > 0) {
