...
import com.icow.basiclibrary.db.annotation.*;
import com.icow.basiclibrary.db.annotation.Column;
import com.icow.basiclibrary.db.annotation.Finder;
import com.icow.basiclibrary.db.annotation.Foreign;
import com.icow.basiclibrary.db.annotation.Id;
import com.icow.basiclibrary.db.converter.ColumnConverter;
import com.icow.basiclibrary.db.converter.ColumnConverterFactory;
import com.icow.basiclibrary.db.sqlite.FinderLazyLoader;
import com.icow.basiclibrary.db.sqlite.ForeignLazyLoader;
...
public class ColumnUtils {
    ...
    public static Method getColumnGetMethod(Class<?> entityType, Field field) {
        ...
        if (getMethod == null) {
            ...
            try {
                ...
                LoggerUtil.d(methodName + " not exist");
            }
        }
    ...
    public static Class<?> getForeignEntityType(com.icow.basiclibrary.db.table.Foreign foreignColumn) {
    ...
    @SuppressWarnings("unchecked")
    public static Class<?> getFinderTargetEntityType(com.icow.basiclibrary.db.table.Finder finderColumn) {
