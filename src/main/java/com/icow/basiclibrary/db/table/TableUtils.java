...
import com.icow.basiclibrary.db.annotation.Table;
...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, com.icow.basiclibrary.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.icow.basiclibrary.db.table.Id>();

    /* package */
    static synchronized com.icow.basiclibrary.db.table.Id getId(Class<?> entityType) {
        ...
        com.icow.basiclibrary.db.table.Id id = new com.icow.basiclibrary.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        com.icow.basiclibrary.db.table.Id id = getId(entityType);
